<template>
  <div class="video-background-page">
    ...
    <mdb-view>
      ...
      <mdb-mask class="d-flex align-items-center gradient">
        <mdb-container class="px-md-3 px-sm-0">
          <mdb-row>
            <mdb-col md="12" class="mt-5 white-text offset-1" :style="{'text-align': 'left'}">
              ...
              <!-- <mdb-btn @click="$router.push({path:'login'})" outline="white" rounded color="white" >
                <mdb-icon icon="place-of-worship"/> Lanuch
              </mdb-btn> -->
              ...
              <form v-on:submit.prevent="asyncContact">
                <mdb-modal :show="showModalContact" @close="showModalContact = false" cascade class="text-left">
                  <mdb-modal-header class="purple white-text">
                    <h4 class="title"><mdb-icon icon="paper-plane" /> Contact Us </h4>
                  </mdb-modal-header>
                  <mdb-modal-body class="grey-text">
                  ...
                  <mdb-modal-footer>
                    <mdb-btn type="submit" class="text-white" rounded color="green">Send <mdb-icon far icon="paper-plane" class="ml-1"/></mdb-btn>
                  </mdb-modal-footer>
                </mdb-modal>
              </form>
...
import { 
  mdbModalTitle,
  mdbCarousel, mdbModal, mdbTextarea, mdbModalHeader, mdbModalBody, mdbModalFooter,mdbInput, mdbNavbar, mdbMask,mdbBtn, mdbNavbarToggler, mdbIcon,mdbNavbarBrand, mdbView, mdbNavbarNav, mdbNavItem, mdbContainer,  mdbRow, mdbCol} from 'mdbvue';
        ...
        if(this.login.username != "" && this.login.password != "") {
            ...
            .then(res => {
              ...
              if ( token ){
                ...
                localStorage.setItem("role", res.data.user.permission);
